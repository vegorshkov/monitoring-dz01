...
Ответ:
Склонировал fork и поправил: https://github.com/vegorshkov/monitoring-sandbox  
Собирем образ, запустив скрипт:
![alt text](image.png)
...
Connection Name: InfluxDB Sandbox
...
Ответ:
Полный список плагинов впечатляет, выношу в отдельный список:
[text](plug-in_telegraf.txt)

Докер блок добавлен в telegraf
![alt text](image-5.png)

![alt text](image-6.png)
метрики телеграф приходят
...
## Дополнительное задание (со звездочкой*) - обязательно к выполнению =)
...
Ответ:
Скрипт готов.
[text](cpu_ram_network_load.py)
![alt text](image-9.png)

Скрипт отработал, создал результирующий файл.
![alt text](image-10.png)

Содержимое:
[text](26-03-25-gid-000455-monitoring.log)

Конфигурируем планировщик заданий:
![alt text](image-11.png)

Оставляем на время, проверяем что записи создаются.
